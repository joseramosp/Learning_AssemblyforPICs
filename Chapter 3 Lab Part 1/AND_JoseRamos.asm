...
; Feb 19 of 2019
	...
	ANDLW 0x03		; Using the AND operator with the value in WREG and 0x03 and saving it in WREG.
	...
	ANDWF REG1,F 		; Using the AND operator with the values in WREG and REG1, and storing the result in the REG1.

	; REG0 ended with the value of 1 as the result of the AND operation between 5 and 3.
	; REG1 ended with the value of 2 as the result of the AND operation between 10 and 2